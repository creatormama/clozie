...
Last updated: **2026-08-08 — Update 4 — Session 33.** Scatter measurement — Hypothesis 1 CONFIRMED and extended: spread, chroma, AND warm/cool side-read all scatter capture-to-capture (blue cardigan spans the full 1.35–1.55 gate on one sweater; 512-wide device-recipe run canonical per App.js:1806/1838). Candidate A LOCKED and untouched; shipping code untouched; no fixes designed. Build 31 stays TestFlight-only; Build 29 / v1.0.5 still LIVE. Full detail: SESSION_NOTES Update 4 — Session 33. main `062d15b` / production `0baff39` untouched, cache 2,510.

**2026-08-07 — Update 4 — Session 32.** Diagnosis only — bench-vs-device blue mismatch SOLVED in mode: bench babyblue "pass" was knife-edge luck (spread 1.358 vs gate floor 1.35, margin 0.008); Candidate A has a design hole at chroma ~0.09 (no protection band covers it); Build 31 device card shows ~half-strength cool-side wash (Hypothesis 1 capture-to-capture knife-edge variation = confirmed-mode leading; Hypothesis 2 port parity alive as secondary — brightness anomaly unexplained). Blue washout is NOT a Build 31 regression — Build 29 washes blues too (Grace-verified). No fixes, no sweeps, no parameter changes; Candidate A locked; shipping code untouched; **Build 31 stays TestFlight-only; Build 29 / v1.0.5 still LIVE.** Next: SEVERAL fresh blue-cardigan captures per light, both lights, bench-measured FIRST. Full detail: SESSION_NOTES Update 4 — Session 32. main `062d15b` / production `0baff39` untouched, cache 2,510.
