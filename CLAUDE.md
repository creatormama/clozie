...
Last updated: **2026-07-14 — Update 4, Session 7 (Build 26 — EAS build + TestFlight PASS):** Build 26 (v1.0.5, commit `fb29844`) built and on-device TestFlight-verified — but TestFlight-only, NOT released; Build 25 / v1.0.4 stays LIVE on the App Store and the 1.0.5 train stays OPEN. One tuning finding for Session 3 logged in KNOWN ISSUES. Full detail: SESSION_NOTES Update 4 — Session 7.
